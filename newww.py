    ...
    while True:
        if procesos_listos:
            ...
            if recurso_semaforo.acquire(blocking=False):
                ...
                # Verificar si ha alcanzado el límite de bloqueos
                ...
                # Simular que el proceso pasa por bloqueado solo si no ha alcanzado el límite
                elif proceso_ejecucion.veces_bloqueado < 3:
